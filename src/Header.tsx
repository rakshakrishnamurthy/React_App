    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-dark text-black-50" style={{ height: '50px' }}>
            <div className="container-fluid ml-0">
                ...
                <div className="text-white active"><h3>Encompass</h3></div>
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <li className="nav-item">
                        <a className="text-white" href="#">Encompass Core</a>
                    </li>
                    <li className="nav-item">
                        <a className="text-white" href="#">Email Marketing</a>
                    </li>
                    <li className="nav-item">
                        <a className="text-white" href="#">Online Giving</a>
                    </li>
